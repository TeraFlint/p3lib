...
/*
	I'm not quite happy with the names here, they don't feel very expressive.
	the higher order list doesn't feel very useful, either. so, what about this...?

	struct type_list
	concept type_collection

	struct value_list	
	concept value_collection
*/
